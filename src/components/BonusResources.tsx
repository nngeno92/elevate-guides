...
export default function BonusResources() {
  return (
    <div className="bg-gradient-to-br from-orange-50 via-yellow-50 to-red-50 border-2 border-orange-200 rounded-2xl p-8 mb-12 relative overflow-hidden">
      {/* Background Pattern */}
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">100+ Business Ideas in Kenya</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                <span className="text-2xl">💡</span>
                <div>
                  <h3 className="font-semibold text-gray-900">General Business Tips</h3>
                  <p className="text-gray-700">To Be Profitable</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                <span className="text-2xl">📲</span>
                <div>
                  <h3 className="font-semibold text-gray-900">Daily Digital Marketing Tips</h3>
                  <p className="text-gray-700">Stay ahead of the competition</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">Tax, Loan & Profit Calculators</p>
                </div>
              </div>
            </div>
